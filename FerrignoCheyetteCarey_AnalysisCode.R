# Ferrigno, Cheyette, & Carey - Creating recursive, center-embedded sequences with an iterative queue.
...
d <- read.csv('FerrignoCheyetteCarey_Data.csv', na = c("", "NA"))
...
tab_model(MaxRegRT6C, MaxRegRT8C,  title = "Table S7: Response time by item number", dv.labels = c("6-item Array", "8-item Array"), file = "S7.doc")
...
############################################################
#### OVERALL Response Time analyses - not included in main text (see SI)
############################################################
